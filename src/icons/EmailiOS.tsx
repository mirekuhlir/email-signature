...
interface EmailIosProps {
  width?: number | string;
  height?: number | string;
  className?: string;
}

export const EmailIos: React.FC<EmailIosProps> = ({
  width = 40,
  height = 40,
  className,
}) => {
    ...
    >
      <defs id="defs4">
        <linearGradient id="linearGradient3068">
          <stop
            style={{ stopColor: '#70efff', stopOpacity: 1 }}
            offset="0"
            id="stop3070"
          />
          <stop
            style={{ stopColor: '#5770ff', stopOpacity: 1 }}
            offset="1"
            id="stop3072"
          />
        </linearGradient>
        <linearGradient id="linearGradient3013">
          <stop
            id="stop3015"
            offset="0"
            style={{ stopColor: '#0255fb', stopOpacity: 1 }}
          />
          <stop
            id="stop3017"
            offset="1"
            style={{ stopColor: '#13ddf5', stopOpacity: 1 }}
          />
        </linearGradient>
        <linearGradient id="linearGradient3915">
          <stop
            style={{ stopColor: '#0081f8', stopOpacity: 1 }}
            offset="0"
            id="stop3917"
          />
          <stop
            style={{ stopColor: '#01ddff', stopOpacity: 1 }}
            offset="1"
            id="stop3919"
          />
        </linearGradient>
        <linearGradient id="linearGradient3883">
          ...
          />
          <stop
            style={{ stopColor: '#0081f8', stopOpacity: 0 }}
            offset="1"
            id="stop3887"
          />
        </linearGradient>
        <linearGradient id="linearGradient3843">
          <stop
            id="stop3851"
            offset="0"
            style={{ stopColor: '#3d73c3', stopOpacity: 1 }}
          />
          <stop
            style={{ stopColor: '#0064f5', stopOpacity: 0.37254902 }}
            offset="0.25"
            id="stop3857"
          />
          <stop
            style={{ stopColor: '#0064f5', stopOpacity: 0.24705882 }}
            offset="0.5"
            id="stop3855"
          />
          <stop
            style={{ stopColor: '#0064f5', stopOpacity: 0 }}
            offset="1"
            id="stop3847"
          />
        </linearGradient>
