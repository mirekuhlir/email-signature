...
>(
  (
    ...
    const buttonBaseClasses =
      'inline-flex items-center justify-center h-10 px-4 text-base font-medium cursor-pointer focus:z-10 focus:ring-2 focus:outline-none transition duration-150 ease-in-out';
