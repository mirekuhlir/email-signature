              ...
              <div className="max-w-[1200px] mx-auto px-4 sm:px-6 relative">
                <div className="max-w-2xl">
                  ...
                  <p className="text-lg sm:text-xl mb-8 text-blue-100">
                    With our tools, you can easily and quickly realize your
                    ideas.
                  </p>
                  ...
                  {[
                    {
                      ...
                      description:
                        "We started with a vision to change the world.",
                    },
                    {
                      year: "2021",
                    ...
                    },
                    {
                      ...
                      description:
                        "We have introduced revolutionary solutions.",
                    },
                  ].map((item, idx) => (
                    <div
                      key={idx}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  {[
                    ...
                    >
                      ...
                      <p className="text-gray-600">
                        We provide professional solutions tailored to your
                        needs.
                      </p>
                    </div>
                  ))}
                ...
                <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-12 shadow-2xl">
                  <div className="max-w-2xl mx-auto text-center">
                    ...
                    <p className="text-lg text-white/80 mb-8">
                      ...
                      our new services and promotions.
                    </p>
              ...
              <div className="max-w-[1200px] mx-auto px-4 sm:px-6 py-16">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
                  <div>
                    ...
                    <p className="text-gray-400">
                      We are a modern company focused on providing quality
